...
__decorate([
    (0, typeorm_1.Column)('text', { default: 'https://placehold.co/500x500' }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => profile_entity_1.ProfileEntity, (profile) => profile.products, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'profile_id' }),
    __metadata("design:type", profile_entity_1.ProfileEntity)
], ProductEntity.prototype, "profile", void 0);
