...
const create_product_dto_1 = require("../application/models/create-product.dto");
const delete_product_dto_1 = require("../application/models/delete-product.dto");
...
let ProductsController = class ProductsController {
    ...
    deleteProduct(request, deleteProduct) {
        return this.productsService.deleteProduct(request.profile_id, deleteProduct.id);
    }
    ...
    updateProduct(request, productId, product) {
        return this.productsService.updateProduct(request.profile_id, productId, product);
    }
};
__decorate([
    (0, common_1.Post)(),
