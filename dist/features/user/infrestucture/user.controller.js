...
const create_user_dto_1 = require("../application/models/create-user.dto");
const delete_user_dto_1 = require("../application/models/delete-user.dto");
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UserController.prototype, "finAllUsers", null);
